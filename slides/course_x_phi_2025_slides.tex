...
\textbf{Gruppenzuordnung}
   \begin{itemize}
      \item Gruppe 1 (Özden, Uelhoff): \textbf{Künstliche Intelligenz und Verantwortung}
      \item Gruppe 2 (Dierks, Siebels, Störmann): \textbf{Sterbehilfe}
      \item Gruppe 3 (Reinken, Weever): \textbf{Widersprüche, Paradoxien, Lügen}
      \item Gruppe 4 (Burghardt, Heinks): \textbf{Trolley-Problem}
   \end{itemize}
\end{frame}
